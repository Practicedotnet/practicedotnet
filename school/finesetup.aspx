<%@ Page Title="" Language="C#" MasterPageFile="~/School.Master" AutoEventWireup="true" CodeBehind="finesetup.aspx.cs" Inherits="school.finesetup" %>
    ...
    <main style="margin-top: 15px">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <asp:Button ID="btnfinelist" runat="server" Text="Fees Group List" Height="28px" CssClass="form-control" OnClick="btnfinelist_Click"  />
                </div>
                <div class="col-md-2">
                    <asp:Button ID="btncreatefine" runat="server" Text="Create Fees Group" CssClass="form-control" Height="28px" OnClick="btncreatefine_Click" />
                </div>
            </div>
            <hr />
            <div runat="server" id="divfinelist" visible="true">
                <h6>fine list</h6>

            </div>
            <div runat="server" id="divcreatefine" visible="false">
