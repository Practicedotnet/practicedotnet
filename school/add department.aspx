 ...
 <h5>Add Department</h5></div>
            ...
            <div class="col-sm-2">
                <div class="container1">
                    ...
                    <div>
                         <asp:GridView runat="server" AutoGenerateColumns="False" DataKeyNames="Did" DataSourceID="SqlDataSource2" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal" Height="39px" Width="346px" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True">
                            <Columns>
                    ...
                    <div class="row">
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolConnectionString %>" SelectCommand="SELECT * FROM [Designation]"></asp:SqlDataSource>
                    </div>
                </div>
            </div>
        </div>
