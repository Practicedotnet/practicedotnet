...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <asp:Label ID="lblcreatetemplate" runat="server" Text="Create Template"></asp:Label>
            </div>
        </div><hr />
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-2">
                <asp:Label ID="lblsalarygrade" runat="server" Text="Salary Grade"></asp:Label>
            </div>
            <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-2">
                <asp:Label ID="lblovertimerate" runat="server" Text="Overtime Rate(per hour)"></asp:Label>
            </div>
            <div class="col-md-4">
        ...
        <div class="container3">
            <h6>Salary Details</h6><hr />
            <div class="row">
                <div class="col-md-4">
                    <asp:Label ID="lblbasicsalary1" runat="server" Text="Basic Salary"></asp:Label>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-4">
                    <asp:Label ID="lbltotalallowance" runat="server" Text="Total Allowance"></asp:Label>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-4">
                    <asp:Label ID="lbltotaldeductions" runat="server" Text="Total Deductions"></asp:Label>
                </div>
                <div class="col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <asp:Button ID="btnsave" runat="server" Text="Save" CssClass ="form-control" Height="25px" Font-Size="11px" />
            </div>
        </div>
    </div>
    </main>
