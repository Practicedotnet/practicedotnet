  ...
  <div class="container pt-4"></div>
    ...
    <div class="row">
     ...
     <div class="row">
         ...
         <div class="col-md-3">
             <asp:TextBox ID="txtregdno" runat="server" CssClass ="form-control "></asp:TextBox>
         </div>
         <div class="col-md-3">
             <asp:TextBox ID="txtroll" runat="server" CssClass ="form-control "></asp:TextBox>
         </div>
         <div class="col-md-3">
             <asp:TextBox ID="txtadmndate" runat="server" TextMode ="Date" CssClass ="form-control"></asp:TextBox>
         </div>
     </div><br />
     <div class="row">
         <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-6">
                <asp:DropDownList ID="DropDownListbloodgrp" runat="server" CssClass ="form-control ">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <asp:TextBox ID="txtcaste" runat="server" CssClass ="form-control "></asp:TextBox>
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
        ...
        <div class="row">
           <div class="col-md-6">
              <asp:FileUpload ID="FileUpload1" runat="server" CssClass ="form-control " width="1100px" Height="200px"></asp:FileUpload>
           </div>
        </div>  <br /><br />
        <h3>Login Details</h3>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <asp:TextBox ID="txtretypepassword" runat="server" CssClass ="form-control"></asp:TextBox>
            </div>
        </div><br /><br />
        <h3>Gaurdian Details</h3><hr />
        <div class="row">
            <div class="col">
        ...
        <div class="row">
            <div class="col-md-3">
                <asp:TextBox ID="txtgcity" runat="server" CssClass ="form-control"></asp:TextBox>
            </div>
            <div class="col-md-3">
                <asp:TextBox ID="txtgstate" runat="server" CssClass ="form-control"></asp:TextBox>
            </div>
            <div class="col-md-3">
                <asp:TextBox ID="txtgmobileno" runat="server" CssClass ="form-control"></asp:TextBox>
            </div>
            <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-12">
            <textarea id="txtareagaddress" cols="50" rows="2" class="form-control" width="1100px" Height="200px"></textarea>  
           </div>
         </div><br />
        <div class="row">
        ...
        <div class="row">
           <div class="col-md-6">
              <asp:FileUpload ID="FileUploadgaurdenphoto" runat="server" CssClass ="form-control " width="1100px" Height="200px"></asp:FileUpload>
           </div>
        </div>  <br /><br />
        <h3>Transportation Details</h3><hr />
        <div class="row">
            <div class="col-md-6">
        ...
        <h3>Previous School Details</h3><hr />
        <div class="row">
            <div class="col-md-6">
