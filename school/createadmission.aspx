    ...
    <main style="margin-top: 58px;">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <asp:TextBox ID="txtadmndate" runat="server" TextMode="Date" CssClass="form-control" Height="25px" Width="200px"></asp:TextBox>
                </div>
            </div>
            <br />
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <asp:TextBox ID="txtdob" runat="server" TextMode="Date" Height="25px" Width="200px"></asp:TextBox>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
